        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
          ...
          <form onSubmit={submit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" value={email} onChange={e => setEmail(e.target.value)}
                  className="w-full bg-gray-800 border border-gray-700 text-white text-sm rounded-xl pl-9 pr-3 py-2.5 focus:outline-none focus:border-indigo-500" />
              </div>
            </div>
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPw ? "text" : "password"} value={password} onChange={e => { setPassword(e.target.value); setError(""); }}
                  ...
                  className="w-full bg-gray-800 border border-gray-700 text-white text-sm rounded-xl pl-9 pr-10 py-2.5 focus:outline-none focus:border-indigo-500 placeholder-gray-600" />
            ...
            <button type="submit" disabled={submitting}
              className="w-full bg-indigo-600 hover:bg-indigo-700 disabled:opacity-60 text-white font-bold py-3 rounded-xl transition text-sm mt-2">
